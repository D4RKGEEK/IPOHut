...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    try {
        ...
        const title = `${ipoName} Allotment Status Out: Check Direct Link Online Now`;
        const description = `Is the ${ipoName} allotment out? Check your status instantly via PAN, Application Number, or DP ID. Use this direct link to the ${registrarName} portal for official results.`;
